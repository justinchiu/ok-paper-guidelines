...
**Goal:** Import only what you need to explain your contributions.

Think of it as: `from neurips import X` — import only what you need.
...
| Background | Import what you need | Minimal notation setup |
